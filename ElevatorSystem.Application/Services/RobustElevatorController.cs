...
/// <summary>
/// Robust elevator controller with comprehensive failure handling and monitoring
/// </summary>
public class RobustElevatorController : IElevatorController, IDisposable
{
    private readonly ICommandBus _commandBus;
    private readonly IRequestStatusTracker _statusTracker;
    private readonly IHealthMonitor _healthMonitor;
    private readonly ILogger<RobustElevatorController> _logger;
    private volatile bool _disposed = false;

    public RobustElevatorController(
        ICommandBus commandBus,
        IRequestStatusTracker statusTracker,
        IHealthMonitor healthMonitor,
        ILogger<RobustElevatorController> logger)
    {
    ...
    public void Dispose()
    {
        ...
        {
            _disposed = true;
            _logger.LogInformation("RobustElevatorController disposed");
        }
    }
}